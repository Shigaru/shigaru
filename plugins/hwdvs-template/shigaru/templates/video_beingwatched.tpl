			...
			<div class="content_box">
				...
				<div class="beingwatched_header">
					<div>
							<ul>
								...
								{if ($smarty.foreach.outer.iteration is div by 5 and ($smarty.foreach.outer.iteration) neq $smarty.foreach.outer.total) or $smarty.foreach.outer.index eq 0}
				...
				<div class="slidesWrapper">					
					...
					{foreach name=outer key=k item=data from=$nowlist}
						...
						{if ($smarty.foreach.outer.iteration is div by 5 or ($smarty.foreach.outer.iteration) eq $smarty.foreach.outer.total) and $smarty.foreach.outer.index neq 0}	
							</ul>
							</div>
