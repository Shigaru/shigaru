		...
		<ul class="nav nav-list mtop12">
		  <li id="aboutme"><a href="index.php?option=com_hwdvideoshare&task=yourvideoscreated&lang={$lang}">{$smarty.const._HWDVIDS_SHIGARU_ABOUTME}</a></li>
		  	
		  <li id="whattowatch"><a href="index.php?option=com_hwdvideoshare&task=yourvideoscreated&lang={$lang}">{$smarty.const._HWDVIDS_SHIGARU_WHATTOWATCH}</a></li>	
		  ...
		  <li id="mysubcriptions"><a href="index.php?option=com_hwdvideoshare&task=yourvideoscreated&lang={$lang}">{$smarty.const._HWDVIDS_SHIGARU_MYSUBSCRIPTIONS}</a></li>	

		  <li id="myalerts"><a href="index.php?option=com_hwdvideoshare&task=yourvideoscreated&lang={$lang}">{$smarty.const._HWDVIDS_SHIGARU_MYALERTS} </a><span class="mleft6"><i class="icon-bell"></i> <span class="fontred">(0) New</span></span></li>	

		  <li id="myvideos">
			<a href="index.php?option=com_hwdvideoshare&task=yourvideos&lang={$lang}">{$smarty.const._HWDVIDS_SHIGARU_MYVIDEOS}</a>
			<ul class="mtop6">
