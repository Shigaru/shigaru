...
<div id="videouploadwrap">
			...
			<div  class="mbot12">
				<form name="videoupload" action="{$form_upload}" method="post">
					<div class="f90 mtop12">{$smarty.const._HWDVIDS_SHIGARU_THANKYOU} <span class="boldred">{$username}</span> {$smarty.const._HWDVIDS_SHIGARU_SUBMIT_THANKYOU_DECIDING}</div>
					<div class="f90 mtop12"><span class="fontbold">Step 1/2: </span>Copy and paste the url (link) of the music tutorial that you have uploaded or found on another site.</div>
						<div  class="tright">
						...
						<div  class="fright tright">
						  <button type="submit" name="send"  class="reddbuttonsubmit button fnone mtop12" ><span class="icon-share-alt mright6"></span>{$smarty.const._HWDVIDS_SHIGARU_SUBMITURL}</button>
