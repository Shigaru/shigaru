...
<div class="clearfix mtop12 f80">
	...
	<div class="fleft w15">
		...
		<div class="mleft6 clearfix mtop20 mbot20">
			<div class="fontbold"><a class="mtop6 pad12 btn btn-danger fleft" href="{$uploadLink}"><i class="icon-share icon-4x fontwhite"></i> <span class="icon-2x fontwhite">{$smarty.const._HWDVIDS_SHIGARU_SUBMIT_TO_SHIGARU}</span></a></div>
		</div> 
