...
DEFINE("_HWDVIDS_META_SRCCEE","No results found, check out some of these random videos...");
...
DEFINE("_HWDVIDS_BUTTON_ADD","Submit");
...
DEFINE("_HWDVIDS_SHIGARU_ACOUSTICGUITAR","Acoustic Guitar");
DEFINE("_HWDVIDS_SHIGARU_CLASSICALGUITAR","Classical Guitar");
DEFINE("_HWDVIDS_SHIGARU_ELECTRICGUITAR","Electric Guitar");
DEFINE("_HWDVIDS_SHIGARU_FLAMENCOGUITAR","Flamenco Guitar");
DEFINE("_HWDVIDS_SHIGARU_VOICE","Voice");
DEFINE("_HWDVIDS_SHIGARU_BALALAIKA","Balalaika");
DEFINE("_HWDVIDS_SHIGARU_BANJO","Banjo");
DEFINE("_HWDVIDS_SHIGARU_BASS GUITARR","Bass Guitarr");
