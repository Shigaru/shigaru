...
DEFINE("_HWDVIDS_MVAT","Más <br /> vistos");
...
DEFINE("_HWDVIDS_MFAT","Más añadidos a favoritos");
...
DEFINE("_HWDVIDS_MPAT","Más <br /> populares");
DEFINE("_HWDVIDS_BWN","Se están viendo ahora...");
DEFINE("_HWDVIDS_RELATED","Relacionados");
DEFINE("_HWDVIDS_UNKNOWN","Desconocido");
DEFINE("_HWDVIDS_RECENT","Reciente");
DEFINE("_HWDVIDS_MOST_RECENT","Más <br /> recientes");
DEFINE("_HWDVIDS_MOST_RATED","Más <br /> votados");
DEFINE("_HWDVIDS_MOST_COMMENTED","Más <br /> comentados");
DEFINE("_HWDVIDS_FEATURED_VIDEOS","Videos Patrocinados");
DEFINE("_HWDVIDS_POP_BANDS","Grupos populares");
DEFINE("_HWDVIDS_POP_TAGS","Etiquetas Populares");
DEFINE("_HWDVIDS_POP_GENRES","Géneros Populares");
...
DEFINE("_HWDVIDS_DESC","Descripci'on");
...
DEFINE("_HWDVIDS_HOMEPROMO","Accede. Sube videos o links a videos de tutoriales de música. Comenta. Valora. Descubre. Aprende. Comparte. Crea una pagina de perfil. Haz amigos. Promociona tu música.  Join the Shigaru online music community now and meet music lovers from all over the world! 10 reasons to join!");
DEFINE("_HWDVIDS_WATCHMORE","Ver más videos como este");
DEFINE("_HWDVIDS_LATESTCOMM","Ultimos comentarios");
DEFINE("_HWDVIDS_POPUCOMM","Comentarios populares");
DEFINE("_HWDVIDS_DONATETO","Dona a Shigaru.com");
DEFINE("_HWDVIDS_SUBSCRIBE","Subscribete a nuestros correos informativos!");
DEFINE("_HWDVIDS_SUBSARCHIVE","Ver el archivo de correos enviados.");


DEFINE("_HWDVIDS_SHIGARU_ADS","Unos anuncios ...");
