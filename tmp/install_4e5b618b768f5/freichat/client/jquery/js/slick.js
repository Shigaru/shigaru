    ...
    $.fn.dcSlick = function(options) {
        ...
        return $dcSlickObj.each(function(options){
            ...
            function slickSetup(obj){
                ...
                $(obj).addClass(defaults.location).addClass('align-'+defaults.align).css({
                    position: 'fixed', 
                    zIndex: 10000
                });
                if(outerH > maxHeight){
                ...
                if(defaults.location == 'top'){
                    ...
                    $tab.css({
                        marginBottom: '-'+tabHeightPx
                        });
					
                    if(defaults.align == 'left'){
                        $(obj).css({
                            left: defaults.offset
                            });
                        $tab.css({
                            left: 0
                        });
