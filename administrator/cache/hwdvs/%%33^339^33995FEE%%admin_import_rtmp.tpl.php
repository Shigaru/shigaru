<?php /* Smarty version 2.6.26, created on 2010-07-12 09:42:32
         compiled from admin_import_rtmp.tpl */ ?>
...
<div style="text-align:left;padding:5px;margin:5px;border:1px solid #ccc;background:#f5f5ee;">
  <h3><?php echo @_HWDVIDS_IMPT_RTMP_TITLE; ?>
</h3>
...
: <a href="http://documentation.hwdmediashare.co.uk/wiki/Import_Videos_from_SQL_Backup_File" target="_blank">http://documentation.hwdmediashare.co.uk/wiki/Import_Videos_from_SQL_Backup_File</a>
  <p><?php echo @_HWDVIDS_IMPT_RTMP_DESC; ?>
</p>
</div>

<div style="border:1px solid #c30;color:#333333;background:#e9ddd9;font-weight: bold;text-align:left;padding:5px;margin:5px;"><?php echo @_HWDVIDS_IMPT_RTMP_WARN; ?>
</div>
...
<form name="importFormRemote" action="index.php" method="post" onsubmit="return chk_importFormRemote()">
  <table cellpadding="0" cellspacing="0" border="0">
    ...
    <tr><td width="150"><?php echo @_HWDVIDS_RTMPURL; ?>
 <font class="required">*</font></td><td><input name="rtmpurl" value="" class="inputbox" size="20" maxlength="600" style="width: 200px;" /></td></tr>
