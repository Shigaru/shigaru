<?php /* Smarty version 2.6.26, created on 2010-07-06 00:03:43
         compiled from admin_reported_videos.tpl */ ?>
  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th class="title"><?php echo @_HWDVIDS_REP_INGOREV; ?>
</th>
    ...
    <tbody>
      <?php $_from = $this->_tpl_vars['list_videos']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['outer'] = array('total' => count($_from), 'iteration' => 0);
...
','deleteReportedVideo')"><img src="<?php echo $this->_tpl_vars['mosConfig_live_site']; ?>
/administrator/components/com_hwdvideoshare/assets/images/icons/delete.png" border="0" alt="Delete Video" /></a></td>
        <td><a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $this->_tpl_vars['data']->i; ?>
','readReportedVideo')"><img src="<?php echo $this->_tpl_vars['mosConfig_live_site']; ?>
