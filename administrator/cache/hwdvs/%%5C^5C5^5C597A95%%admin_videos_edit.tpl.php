<?php /* Smarty version 2.6.26, created on 2011-12-10 19:05:31
...
" size="20" maxlength="50"></td>
                ...
                <tr>
                  <td><?php echo @_HWDVIDS_VIEWS; ?>
</td>
                  <td><input name="views" value="<?php echo $this->_tpl_vars['views']; ?>
" size="20" maxlength="50"></td>
                </tr> 
                <tr>
                  <td>Age Check</td>
                  <td><?php echo $this->_tpl_vars['age_check']; ?>
</td>
                </tr>                 
...
'; ?>
 ...
 <span onclick="ajaxChangeUser();" style="cursor:pointer;">[<?php echo @_HWDVIDS_CHANGEUSER; ?>
	      ...
	      <div id="passwordField" <?php if ($this->_tpl_vars['row']->public_private != 'password'): ?>style="visibility:hidden;height:0;"<?php endif; ?>>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		  <tr>
		    <td width="150"><?php echo @_HWDVIDS_PASSWORD; ?>
</td>
		    <td>
	      ...
	      <div id="groupField" <?php if ($this->_tpl_vars['row']->public_private != 'group'): ?>style="visibility:hidden;height:0;"<?php endif; ?>>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		  <tr>
		    <td width="150" valign="top"><?php echo @_HWDVIDS_SELECT_JACG; ?>
</td>
		    <td>
		      <?php echo $this->_tpl_vars['gtree_video']; ?>

		    </td>
		  </tr>
		</table>
              </div>
	      <div id="levelField" <?php if ($this->_tpl_vars['row']->public_private != 'level'): ?>style="visibility:hidden;height:0;"<?php endif; ?>>
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
		  <tr>
		    <td width="150" valign="top"><?php echo @_HWDVIDS_SELECT_JACL; ?>
</td>
		    <td>
		      <?php echo $this->_tpl_vars['jacl_video']; ?>
...
<?php if ($this->_tpl_vars['j16']): ?>
	<?php echo $this->_tpl_vars['videoPermissions']; ?>
...
<br />
        <?php if ($this->_tpl_vars['print_missingfile']): ?>
        <center><h2><div style="color:#ff0000;"><?php echo @_HWDVIDS_ALERT_MISSINGVIDFILE; ?>
</div></h2></center>
        <?php endif; ?>
