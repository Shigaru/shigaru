	...
	function showgeneralsettings(&$gtree)
	{
		...
		?>
  		<div style="width:100%;margin-top:5px;text-align:left;">
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  <tr><td align="left" valign="top" colspan="3"><h3>Local Video Protection</h3></td></tr>
			  <tr>
				<td width="20%" align="left" valign="top"><b>Video Directory</td>
				<td align="left" valign="top" width="20%"><input type="text" name="vsdirectory" value="<?php echo $c->vsdirectory; ?>" size="40" maxlength="100" disabled="disabled"></td>
				<td width="60%" align="left" valign="top">Server path to the video directory</td>
			  </tr>
			  <tr>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="adminform">
			  ...
			  <tr>
				...
				<select name="search_method" size="1" class="inputbox">
					...
					<option value="2"<?php if ($c->search_method == 0) { ?> selected="selected"<?php } ?>>Pattern Matching (Slower)</option>
				</select>
				</td>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  ...
			  <tr>
				<td width="20%" align="left" valign="top"></td>
				<td width="80%" align="left" valign="top" colspan="2">Set the frequency of keyframes in your video.</td>
			  </tr>
			</table>
			<table cellpadding="0" cellspacing="0" border="0" width="95%" class="adminform">
			  <tr>
