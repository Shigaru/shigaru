...
"Hallo %you%,\n\n%user% heeft je het volgende nieuwe privé bericht gestuurd vanaf %site%.\n__________________\n%pmessage%");
DEFINE ('_UDDEIM_EMN_BODY_NOMESSAGE',
"Hallo %you%,\n\n%user% heeft je een privé bericht gestuurd vanaf %site%. Om het bericht te lezen, dien je in te loggen op\n\n%livesite%");
DEFINE ('_UDDEIM_EMN_BODY_WITHMESSAGE',
"Hallo %you%,\n\n%user% heeft je een privé bericht gestuurd vanaf %site%. Om het bericht te beantwoorden, dien je in te loggen \n\n%livesite%\n__________________\n%pmessage%");
