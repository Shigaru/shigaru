...
<form action="index.php?tmpl=component&amp;option=<?php echo ACYMAILING_COMPONENT ?>" method="post" name="adminForm" autocomplete="off" enctype="multipart/form-data">
	<fieldset>
		<div class="header icon-48-acytemplate" style="float: left;"><?php echo JText::_('TEMPLATE'); ?></div>
		<div class="toolbar" id="toolbar" style="float: right;">
			<table><tr>
			<td><a onclick="javascript:submitbutton('doupload'); return false;" href="#" ><span class="icon-32-save" title="<?php echo JText::_('UPLOAD',true); ?>"></span><?php echo JText::_('UPLOAD'); ?></a></td>
