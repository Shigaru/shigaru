...
<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>" method="post" name="adminForm" autocomplete="off">
	<fieldset>
		...
		<div class="toolbar" id="toolbar" style="float: right;">
			<table><tr>
			<td><a onclick="javascript:submitbutton('savecss'); return false;" href="#" ><span class="icon-32-save" title="<?php echo JText::_('SAVE',true); ?>"></span><?php echo JText::_('SAVE'); ?></a></td>
			</tr></table>
		</div>
	</fieldset>
