<?php
/**
* @version $Id:001(first v.) kunena.german.php  Kunena 1.5.11 / informal 2010-03-24 11:41:00 Lintzy $
**
* Kunena Component
* @package Kunena
*
...
* Translation Kunena v. 1.0.8 - v.1.0.11 and v. 1.5.0 - v.1.5.11 by Angelika Reisiger (Lintzy)
* @copyright (C) 2009-2010 Lintzy / Angelika Reisiger / http://www.webdesign-welt.de/ All Rights Reserved
**/
...
// 1.5.11
define('_KUNENA_SECTION','Bereich');
define('_KUNENA_NOBODY','Niemand');
// Disable userlist
define('_USERLIST_DISABLED','Die Kunena Benutzerliste wurde deaktiviert, sodass kein Zugriff darauf besteht.');
define('_KUNENA_ADMIN_CONFIG_USERLIST_ENABLE','Benutzerliste aktivieren');
define('_KUNENA_ADMIN_CONFIG_USERLIST_ENABLE_DESC','Diese Benutzerliste entweder aktivieren oder, falls sie nicht genutzt werden soll, deaktivieren.');
// Anonymous posting
define('_KUNENA_CATEGORY_ANONYMOUS',"Anonym");
define('_KUNENA_CATEGORY_ANONYMOUS_ALLOW',"Anonyme Beitr&auml:ge erlauben");
define('_KUNENA_CATEGORY_ANONYMOUS_ALLOW_DESC',"Anonyme Beitr&auml:ge k&ouml;nnen von registrierten Benutzern benutzt werden, um sensible Informationen in dieses Forum zu posten: <b>Keine Benutzer relevanten Informationen</b> werden mit den anonymen Beitr&auml:gen gespeichert (auch keine IP-Adressen).");
define('_KUNENA_CATEGORY_ANONYMOUS_DEFAULT',"Standardm&auml;&szlig;ige Anwort als");
define('_KUNENA_CATEGORY_ANONYMOUS_DEFAULT_DESC',"Wenn anonyme Beitr&auml:ge erlaubt wurden, ist diese Option die Standardwahl f&uuml;r den User. Regul&auml;r k&ouml;nnen die Benutzer ihre Beitr&auml:ge im Nachhinein auf anoyme Beitr&auml:ge &auml;ndern, aber nur Moderatoren k&ouml;nnen anonyme Beitr&auml:ge bearbeiten.");
define('_KUNENA_CATEGORY_ANONYMOUS_X_REG',"Registrierte Benutzer");
define('_KUNENA_CATEGORY_ANONYMOUS_X_ANO',"Anonyme Benutzer");
define('_KUNENA_BACK',"Zur&uuml;ck");
define('_KUNENA_POST_AS_ANONYMOUS',"Anonymer Beitrag");
define('_KUNENA_POST_AS_ANONYMOUS_DESC',"Dieser Beitrag beinhaltet sensible Informationen. Alle Benutzerinformationen von diesem Beitrag entfernen.");
define('_KUNENA_POST_ERROR_NO_CATEGORY',"Es wurde keine Kategorie ausgew&auml;hlt um diesen Beitrag zu speichern.");
define('_KUNENA_POST_ERROR_IS_SECTION',"Es besteht keine Berechtigung in dieses Forum Beitr&auml:ge zu schreiben.");
define('_KUNENA_POST_ERROR_ANONYMOUS_FORBITTEN',"Dieses Forum erlaubt keine anonymen Beitr&auml:ge. Um die Privatsp&auml;hre zu wahren, wurde der Beitrag nicht abgeschickt.");
define('_KUNENA_USERNAME_ANONYMOUS',"Anonym");


//1.5.10
DEFINE('_KUNENA_PARENTDESC',
     'Bitte denk dran: Um ein Forum erstellen zu k&ouml;nnen brauchst du eine &quot;Kategorie&quot;. Diese Kategorie bildet die oberste Ebene, das <em>Elternelement</em>, und beinhaltet Foren samt Unterforen.<p>Ein Forum kann <strong>nur</strong> unter einer Kategorie erstellt werden. Ein Unterforum wird in einem &uuml;bergeordneten Forum erstellt.<br /> Beitr&auml;ge k&ouml;nnen <strong>NICHT</strong> in Kategorien geschrieben werden, sondern nur in Foren und Unterforen.');
DEFINE('_KUNENA_ADMIN', 'Forum Administration');
DEFINE('_KUNENA_NOTEUS',
    'Hinweis: Nur User mit dem Kennzeichung Moderator im Profil werden hier gezeigt. Um einen Moderator hinzuzuf&uuml;gen, bitte zu  <a href="index.php?option=com_kunena&task=profiles">User Administration</a> navigieren und den User ausw&auml;hlen, der Moderator werden soll. Die Moderator Kennzeichnung kann nur durch einen Seitenadministrator gesetzt werden.');
DEFINE('_KUNENA_SHOW_AVATAR_ON_CAT_DESC', '&quot;Ja&quot; w&auml;hlen, wenn der Avatar auch in der Kategorieansicht, Aktuelle Beitr&auml;ge und Meine Diskussionen gelistet werden soll.');
DEFINE('_KUNENA_SHOW_AVATAR_ON_CAT', 'Avatar in der Kategorieansicht, Aktuelle Beitr&auml;ge und Meine Diskussionen zeigen?');
DEFINE('_KUNENA_SORTID', 'Sortiert nach Userid');
DEFINE('_KUNENA_SORTMOD', 'Sortiert nach Moderatoren');
DEFINE('_KUNENA_SORTNAME', 'Sortiert nach Usernamen');
DEFINE('_KUNENA_SORTREALNAME', 'Sortiert nach Realnamen');
define('_KUNENA_PDF_NOT_GENERATED_MESSAGE_DELETED', 'Das Thema wurde gel&ouml;scht, somit kann auch kein PDF erstellt werden.');
//Hide Ip
define('_KUNENA_COM_A_HIDE_IP', 'IP in Beitr&auml;gen vor Moderatoren verstecken');
define('_KUNENA_COM_A_HIDE_IP_DESC', 'IP in Beitr&auml;gen vor Moderatoren verstecken und nur den Administratoren zeigen');
//Joomsocial Activity Stream Integration disable/enable
define('_COM_A_JS_ACTIVITYSTREAM_INTEGRATION', 'Die Jomsocial Activity Stream Integration aktivieren');
define('_COM_A_JS_ACTIVITYSTREAM_INTEGRATION_DESC', 'Der Activity Stream zeigt die letzten Beitr&auml;ge oder neuen Themen aus Kunena im Jomsocial Wall.');
// EMail
define('_KUNENA_EMAIL_INVALID', 'Das Forum hat versucht,m eine E-Mail an eine nicht valide Adresse zu senden. Bitte den Administrator kontaktieren!');
define('_KUNENA_MY_EMAIL_INVALID', 'Diese E-Mail-Adresse ist nicht valide. Eine g&uuml;ltige E-Mail-Adresse ist f&uuml;r das Schreiben von Beitr&auml;gen im Forum erforderlich!');

// 1.5.8

define('_KUNENA_USRL_REALNAME', 'Richtiger Name');
define('_KUNENA_SEO_SETTINGS', 'SEO Einstellungen');
define('_KUNENA_SEF', 'Suchmaschinen freundliche URLs');
define('_KUNENA_SEF_DESC', 'Bitte ausw&auml;hlen ob die URLs f&uuml;r Suchmaschinen optimiert werden sollen. HINWEIS: Kunena akzeptiert SEF URLs auch wenn dieses Feature ausgeschaltet wird.');
define('_KUNENA_SEF_CATS', 'Keine Kategorien IDs benutzen');
// Please use words from your own (or nearby) language in the next URL, but only using a-z:
define('_KUNENA_SEF_CATS_DESC', 'Geringf&uuml;gig verbesserte URLs: http://www.domain.com/forum/category/123-message . WARNUNG: Wenn das auf NEIN gesetzt wurde, wird Kunena diese URLs nicht mehr akzeptieren!');
define('_KUNENA_SEF_UTF8', 'UTF8 Support aktivieren');
// Please use words from your own (or nearby) language in the next URL, but make sure that they contain UTF8 letters:
define('_KUNENA_SEF_UTF8_DESC', 'Diese Option sollte gew&auml;hlt werden, wenn SEF URLs nicht lesbar sind. Ergebnis: http://www.domain.com/forum/2-Catégorie/123-Meßage . HINWEIS: Kunena akzeptiert UTF8 URLs auch wenn dieses Feature abgeschaltet bleibt.');
define('_KUNENA_SYNC_USERS_OPTIONS', 'Optionen');
define('_KUNENA_SYNC_USERS_CACHE', 'User Cache l&ouml;schen');
define('_KUNENA_SYNC_USERS_CACHE_DESC', 'Diese Funktion erm&ouml;glicht den Usern die versteckten Foren sofort zu sehen, wenn sich Berechtigung ge&auml;ndert wurde (Usergruppe in Joomla: Registriert, Autor usw).');
define('_KUNENA_SYNC_USERS_ADD', 'Userprofil jedem zuordnen');
define('_KUNENA_SYNC_USERS_ADD_DESC', 'Kunena vergibt neue Userprofile nur, wenn der User das Forum betritt. Diese Funktion vergibt ein Standard-Userprofil f&uuml;r jeden existierenden User.');
define('_KUNENA_SYNC_USERS_DEL', 'Userprofil von gel&ouml;schten User-Accounts entfernen');
define('_KUNENA_SYNC_USERS_DEL_DESC', 'Kunena entfernt nicht automatisch das Userprofil eines gel&ouml;schten Accounts, es wird lediglich versteckt. Diese Option bietet die M&ouml;glichkeit diese Profile alle zu l&ouml;schen.');
define('_KUNENA_SYNC_USERS_RENAME', 'Benutzernamen in Beitr&auml;gen updaten');
define('_KUNENA_SYNC_USERS_RENAME_DESC', 'Mit dieser Option werden alle Autorennamen in Beitr&auml;gen in User- oder Realnamen zur&uuml;ckgesetzt, abh&auml;gig von der in der Kunena Konfiguration getroffenen Einstellung.');
define('_KUNENA_SYNC_USERS_DO_CACHE', 'User Cache wurde gel&ouml;scht');
define('_KUNENA_SYNC_USERS_DO_ADD', 'User Profile hinzugef&uuml;gt:');
define('_KUNENA_SYNC_USERS_DO_DEL', 'User profiles entfernt:');
define('_KUNENA_SYNC_USERS_DO_RENAME', 'Beitr&auml;ge aktualisiert:');

// 1.5.7

define('_KUNENA_JS_ACTIVITYSTREAM_CREATE_MSG1', 'hat ein neues Thema erstellt');
define('_KUNENA_JS_ACTIVITYSTREAM_CREATE_MSG2', 'in den Foren.');
define('_KUNENA_JS_ACTIVITYSTREAM_REPLY_MSG1', 'hat auf ein Thema geantwortet');
define('_KUNENA_JS_ACTIVITYSTREAM_REPLY_MSG2', 'in den Foren.');

define('_KUNENA_AUP_ALPHAUSERPOINTS', 'AlphaUserPoints');
define('_KUNENA_AUP_ENABLED_POINTS_IN_PROFILE', 'Anzeige der AlphaUserPoints erlaubt');
define('_KUNENA_AUP_ENABLED_POINTS_IN_PROFILE_DESC', 'Wenn AlphaUserPoints installiert ist, kann Kunena so konfiguriert werden, dass die Punkte des User&#700;s in seinem Profil angezeigt werden.');
define('_KUNENA_AUP_ENABLED_RULES', 'Regeln f&uuml;r AlphaUserPoints erlaubt');
define('_KUNENA_AUP_ENABLED_RULES_DESC', 'Die vorinstallierten Regeln von AlphaUserPoints k&ouml;nnen genutzt werden, um Punkte f&uuml;r neue Themen und Antworten zu vergeben. AlphaUserPoints 1.5.3 oder sp&auml;ter muss daf&uuml;r installiert sein. Ist eine &auml;ltere Version installiert, m&uuml;ssen die Regeln manuell installiert werden (s. Anleitung f&uuml;r AlphaUserPoints).');
define('_KUNENA_AUP_MINIMUM_POINTS_ON_REPLY', 'Mindestanzahl von Zeichen f&uuml;r eine Antwort');
define('_KUNENA_AUP_MINIMUM_POINTS_ON_REPLY_DESC', 'Die Mindestanzahl an Zeichen in einer Antwort um Punkte zu bekommen.');
define('_KUNENA_AUP_MESSAGE_TOO_SHORT', 'Die Antwort war leider zu kurz, um daf&uuml;r neue Punkte zu erhalten.');
define('_KUNENA_AUP_POINTS', 'Punkte:');

// 1.0.11 and 1.5.4
DEFINE('_KUNENA_MOVED', 'Verschoben');

// 1.0.11 and 1.5.3
DEFINE('_KUNENA_VERSION_SVN', 'SVN Revision');
DEFINE('_KUNENA_VERSION_DEV', 'Entwicklungs-Schnappschuss');
...
DEFINE('_KUNENA_VERSION_INSTALLED', 'Du hast die Kunena Version %s (%s) installiert.');
DEFINE('_KUNENA_VERSION_SVN_WARNING', 'Bitte benutze  niemals eine SVN Revision f&uuml;r etwas anderes als Software Entwicklung!');
DEFINE('_KUNENA_VERSION_DEV_WARNING', 'Dieser interne Release ist nur f&uuml;r Entwickler und Tester!');
DEFINE('_KUNENA_VERSION_ALPHA_WARNING', 'Diese Version sollte nicht auf &ouml;ffentlichen Seiten eingesetzt werden!');
DEFINE('_KUNENA_VERSION_BETA_WARNING', 'Es ist nicht empfohlen, diese Version auf &ouml;ffentlichen Seiten einzusetzen');	
DEFINE('_KUNENA_VERSION_RC_WARNING', 'Diese Version kann m&ouml;glicherweise Bugs enthalten, die in der finalen Version behoben sind.');	
DEFINE('_KUNENA_ERROR_UPGRADE', 'Das Upgrade von Kunena zur Version %s ist fehlgeschlagen!');
DEFINE('_KUNENA_ERROR_UPGRADE_WARN', 'Deinem Forum k&ouml;nnten eventuell wichtige Bugfixes sowie einige Features fehlen und einige Features k&ouml;nnten defekt sein.');
DEFINE('_KUNENA_ERROR_UPGRADE_AGAIN', 'Bitte versuche  das Upgrade erneut. Wenn Du nicht auf Kunena Version %s upgraden kannst, ist der Downgrade zur letzten funktionierenden Version ohne Probleme m&ouml;glich.');
DEFINE('_KUNENA_PAGE', 'Seite');
DEFINE('_KUNENA_RANK_NO_ASSIGNED', 'Kein Rang zugewiesen');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_GENERAL', 'Probleme bei der Integration von Community Builder entdeckt:');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_INSTALL', 'Die Integration von Community Builder funktioniert nur, wenn du Community Builder Version %s oder h&ouml;her installiert hast.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_PUBLISH', 'Die Integration des Community Builder Profils funktioniert nur, wenn du das Community Builder User-Profil in der Kunena Konfiguration ver&ouml;ffentlicht hast.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_UPDATE', 'Die Integration des Community Builder Profils funktioniert nur, wenn du die Community Builder Version %s oder h&ouml;her installiert hast.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_XHTML', 'Die Integration des Community Builder Profils funktioniert nur, wenn der Community Builder im W3C XHTML 1.0 Transitional Compliance Mode ist.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_INTEGRATION', 'Die Integration des Community Builder Profils funktioniert nur, wenn das Forum integration Plugin in Community Builder aktiviert wurde.');
DEFINE('_KUNENA_INTEGRATION_CB_WARN_HIDE', 'Das Abspeichern der Kunena Konfiguration deaktiviert die Integration und zeigt diese Warnung nicht mehr an.');

// 1.0.10
DEFINE('_KUNENA_BACK', 'Zur&uuml;ck');
DEFINE('_KUNENA_SYNC', 'Synchronisieren');
DEFINE('_KUNENA_NEW_SMILIE', 'Neuer Smiley');
DEFINE('_KUNENA_PRUNE', 'Reduzieren');
//Editor
DEFINE('_KUNENA_EDITOR_HELPLINE_BOLD', 'Fetter Text: [b]Text[/b]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ITALIC', 'Kursiver Text: [i]Text[/i]');
DEFINE('_KUNENA_EDITOR_HELPLINE_UNDERL', 'Unterstrichener Text: [u]Text[/u]');
DEFINE('_KUNENA_EDITOR_HELPLINE_STRIKE', 'Durchgestrichener Text: [strike]Text[/strike]');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUB', 'Tiefgestellter Text: [sub]Text[/sub]');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUP', 'Hochgestellter Text: [sup]Text[/sup]');
DEFINE('_KUNENA_EDITOR_HELPLINE_QUOTE', 'Zitierter Text: [quote]Text[/quote]');
DEFINE('_KUNENA_EDITOR_HELPLINE_CODE', 'Code anzeigen: [code]Code[/code]');
DEFINE('_KUNENA_EDITOR_HELPLINE_UL', 'Unsortierte Liste: [ul] [li]Text[/li] [/ul] - Hinweis: Eine Liste muss Listenelemente beinhalten');
DEFINE('_KUNENA_EDITOR_HELPLINE_OL', 'Sortierte Liste: [ol] [li]Text[/li] [/ol] - Hinweis: Eine Liste muss Listenelemente beinhalten');
DEFINE('_KUNENA_EDITOR_HELPLINE_LI', 'Listenelement: [li] Listenelement [/li]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_LEFT', 'Links ausgerichtet: [left]Text[/left]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_CENTER', 'Zentriert: [center]Text[/center]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_RIGHT', 'Rechts ausgerichtet: [right]Text[/right]');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINK', 'Bildlink: [img size=(01-499)]http://www.google.com/images/web_logo_left.gif[/img]');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKSIZE', 'Bildlink: Gr&ouml;&szlig;e von 01 bis 499');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKURL', 'Bildlink: URL des Bildlinkes');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKAPPLY', 'Bildlink: OK');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINK', 'Link: [url=http://www.zzz.com/]Das ist ein Link[/url]');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKURL', 'Link: URL des Linkes');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKTEXT', 'Link: Text / Beschreibung des Linkes');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKAPPLY', 'Link: OK');
DEFINE('_KUNENA_EDITOR_HELPLINE_HIDE','Versteckter Text: [hide]Versteckter Text[/hide] - Verstecken von Text vor G&auml;sten');
DEFINE('_KUNENA_EDITOR_HELPLINE_SPOILER', 'Spoiler: Dieser Text ist nur nach darauf klicken sichtbar');
DEFINE('_KUNENA_EDITOR_HELPLINE_COLOR', 'Farbe: [color=#FF6600]Text[/color]');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE', 'Schriftgr&ouml;&szlig;e: [size=1]Text[/size] - Hinweis: Die Gr&ouml;&szlig;e geht von 1 bis 5');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZESELECTION', 'Schriftgr&ouml;&szlig;e: W&auml;hlen Sie die Schriftgr&ouml;&szlig;e aus, markieren den Text und dr&uuml;cken das Icon links des Auswahlfensters');
DEFINE('_KUNENA_EDITOR_HELPLINE_EBAY', 'eBay: [ebay]ItemId[/ebay]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEO', 'Video: Hier kann zwischen dem Video-Provider oder URL - Modus gew&auml;hlt werden');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOSIZE', 'Video: Gr&ouml;&szlig;e des Video');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOWIDTH', 'Video: Breite des Video');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOHEIGHT', 'Video: H&ouml;he des Video');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOPROVIDER', 'Video: Videoprovider w&auml;hlen');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOID', 'Video: ID des Video - diese ist in der URL beim Aufrufen ersichtlich');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY1', 'Video: [video size=100 width=480 height=360 provider=clipfish]3423432[/video]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEOURL', 'Video: URL des Videos');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_IMGPH', 'Platzhalter [img] einf&uuml;gen f&uuml;r Bildanhang');
DEFINE('_KUNENA_EDITOR_HELPLINE_FILEPH', 'Platzhalter [file] einf&uuml;gen f&uuml;r Dateianhang');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUBMIT', 'Nachricht absenden');
DEFINE('_KUNENA_EDITOR_HELPLINE_PREVIEW', 'Eine Vorschau der Nachricht ansehen');
DEFINE('_KUNENA_EDITOR_HELPLINE_CANCEL', 'Nachricht l&ouml;schen');
DEFINE('_KUNENA_EDITOR_HELPLINE_HINT', 'bbCode-Hilfe - Hinweis: bbCode kann nur auf markierten Text angewandt werden!');
DEFINE('_KUNENA_EDITOR_LINK_URL', ' URL: ');
DEFINE('_KUNENA_EDITOR_LINK_TEXT', ' Text: ');
DEFINE('_KUNENA_EDITOR_LINK_INSERT', 'OK');
DEFINE('_KUNENA_EDITOR_IMAGE_SIZE', ' Gr&ouml;&szlig;e (1-499): ');
DEFINE('_KUNENA_EDITOR_IMAGE_URL', ' URL: ');
DEFINE('_KUNENA_EDITOR_IMAGE_INSERT', 'OK');
DEFINE('_KUNENA_EDITOR_VIDEO_SIZE', 'Gr&ouml;&szlig;e: ');
DEFINE('_KUNENA_EDITOR_VIDEO_WIDTH', 'Breite: ');
DEFINE('_KUNENA_EDITOR_VIDEO_HEIGHT', 'H&ouml;he:');
DEFINE('_KUNENA_EDITOR_VIDEO_URL', 'URL: ');
DEFINE('_KUNENA_EDITOR_VIDEO_ID', 'ID: ');
DEFINE('_KUNENA_EDITOR_VIDEO_PROVIDER', 'Provider: ');
DEFINE('_KUNENA_BBCODE_HIDDENTEXT', '<span class="fb_quote">Dieser Beitragsinhalt ist nur f&uuml;r Mitglieder lesbar. Bitte anmelden oder neu registrieren.</span>');
DEFINE('_KUNENA_EDITOR_HELPLINE_LARGER', 'Mit Klick auf das Plus kann die Textbox vergr&ouml;&szlig;ert werden');
DEFINE('_KUNENA_EDITOR_HELPLINE_SMALLER', 'Mit Klick auf das Minus kann die Textbox wieder verkleinert werden');
// end editor
DEFINE('_KUNENA_PROFILE_BIRTHDAY', 'Geburtstag');
DEFINE('_KUNENA_DT_MONTHDAY_FMT','%d.%m');
DEFINE('_KUNENA_CFC_FILENAME','CSS-Datei wird modifiziert');
DEFINE('_KUNENA_CFC_SAVED','CSS-Datei gespeichert.');
DEFINE('_KUNENA_CFC_NOTSAVED','CSS-Datei gespeichert.');
DEFINE('_KUNENA_JS_WARN_NAME_MISSING','Ihr Name fehlt.');
DEFINE('_KUNENA_JS_WARN_UNAME_MISSING','Dein Username fehlt.');
DEFINE('_KUNENA_JS_WARN_VALID_AZ09','Das Feld enth&auml;lt unerlaubte Buchstaben.');
DEFINE('_KUNENA_JS_WARN_MAIL_MISSING','Die E-Mail-Adresse fehlt.');
DEFINE('_KUNENA_JS_WARN_PASSWORD2','Bitte f&uuml;ge ein g&uuml;ltiges Passwort ein.');
DEFINE('_KUNENA_JS_PROMPT_UNAME','Bitte trage Deinen Usernamen erneut ein.');
DEFINE('_KUNENA_JS_PROMPT_PASS','Bitte trage Dein Passwort erneut ein');
DEFINE('_KUNENA_DT_LMON_DEC', 'Dezember');
DEFINE('_KUNENA_DT_MON_DEC', 'Dez');
DEFINE('_KUNENA_NOGENDER', 'Unbekannt');
DEFINE('_KUNENA_ERROR_INCOMPLETE_ERROR', 'Die Kunena Installation ist abgeschlossen!');
DEFINE('_KUNENA_ERROR_INCOMPLETE_OFFLINE', 'Wegen dem obigen Fehler ist Dein Forum nun offline und die Foren-Administration wurde deaktiviert.');
DEFINE('_KUNENA_ERROR_INCOMPLETE_REASONS', 'M&ouml;gliche Gr&uuml;nde f&uuml;r diesen Fehler:');
DEFINE('_KUNENA_ERROR_INCOMPLETE_1', '1) Der Kunena Installationsprozess ist gescheitert oder es gab ein &quot;Timeout Problem&quot; (versuche  es mit einer neuen Installation)');
DEFINE('_KUNENA_ERROR_INCOMPLETE_2', '2) Du hast einige Kunena Tabellen Deiner Datenbank entfernt');
DEFINE('_KUNENA_ERROR_INCOMPLETE_3', '3) Deine Datenbank ist fehlerhaft');
DEFINE('_KUNENA_ERROR_INCOMPLETE_SUPPORT', 'Du findest unser Support Forum:');
...
DEFINE('_KUNENA_PROFILE_NOT_FOUND', 'Der Benutzer hat das Forum noch nicht besucht und hat noch kein Profil.');
// Search
...
DEFINE('_KUNENA_SAMPLE_MAIN_CATEGORY_DESC', 'Das ist das oberste Level. Eine Kategorie fungiert wie ein Container, der Foren und Unterforen enthält. Sie wird auch als Level 1 Kategorie bezeichnet und ist ein Muss für jede Kunena Forum Einrichtung. Einem Forum ist immer etwas übergeordnet, entweder ein anderes Forum (Eltern- / Haupt-forum) oder eine Kategorie (Level 1 Kategorie) als Container.');
...
DEFINE('_GEN_MERGE', 'Thema oder Beitrag mit einem anderen Thema verbinden');
...
DEFINE('_KUNENA_UP_ATT_10', 'Dateianhangstabelle wurde erfolgreich auf die letzte 1.0.x-Versionsstruktur aktualisiert!');
...
DEFINE('_PERM_NO_READ','Du hast nicht gen&uuml;gend Rechte, um auf dieses Forum zuzugreifen!');
...
DEFINE('_BBCODE_HIDE','Versteckter Text: [hide]Versteckter Text[/hide] - Verstecken von Text vor G&auml;sten');
...
DEFINE('_KUNENA_MYPROFILE_BIRTHDATE_DESC', 'Jahr (YYYY) - Monat (MM) - Tag (DD)');
...
DEFINE ('_KUNENA_USRL_NAME','Benutzername');
DEFINE ('_KUNENA_USRL_REALNAME','Name');
...
DEFINE('_KUNENA_PARENT', 'Elternelement:');
...
DEFINE('_POST_SUCCESS_FAVORITE','Deine Anweisung zum Hinzuf&uuml;gen in die Aboliste wurde durchgef&uuml;hrt!');
...
DEFINE('_KUNENA_SHOW_LATEST_MESSAGES_DESC','W&auml;hle  &quot;Ja&quot; aus, wenn die neuesten Beitr&auml;ge&quot; in einer extra Box angezeigt werden sollen.');
...
DEFINE('_KUNENA_LATEST_CATEGORY_DESC','Spezielle Foren aus &quot;aktuelle Beitr&auml;ge&quot; anzeigen lassen. Beispiel: 2, 3, 7 (leer lassen f&uuml;r alle Foren)');
...
DEFINE('_KUNENA_ANN_MODID_DESC','Hier f&uuml;gst du die IDs der Benutzer, die Ank&uuml;ndigungen verfassen oder moderieren k&ouml;nnen, ein, z.B. 62, 63, 73. Diese Benutzer k&ouml;nnen Ank&uuml;ndigungen hinzuf&uuml;gen, &auml;ndern oder l&ouml;schen.');
//
...
DEFINE('_STAT_TOTAL_CATEGORIES', 'Gesamte Foren');
DEFINE('_STAT_TOTAL_SECTIONS', 'Gesamte Kategorien');
...
DEFINE('_STAT_VIEW_RECENT_POSTS_ON_FORUM', 'Letzte Beitr&auml;ge');
...
DEFINE('_IMAGE_ERROR_WIDTH','Die Breite des Bildes &uuml;berschreitet die vom Administrator zugelassene Breite.');
DEFINE('_IMAGE_ERROR_HEIGHT','Die H&ouml;he des Bildes &uuml;berschreitet die vom Administrator zugelassene H&ouml;he.');
...
DEFINE('_GEN_POST_REPLY', 'Antworten');
...
DEFINE('_BBCODE_CLOSA', 'Alle Tags schlie&szlig;en');
DEFINE('_BBCODE_CLOSE', 'Alle offenen bbCode-Tags schlie&szlig;en');
DEFINE('_BBCODE_COLOR', 'Farbe: [color=#FF6600]text[/color]');
DEFINE('_BBCODE_SIZE', 'Gr&ouml;&szlig;e: [size=1]Textgr&ouml;&szlig;e[/size] - Hinweis: Verf&uuml;gbare Gr&ouml;&szlig;en: 1 bis 5');
