...
class Kunena implements iKunena {
	...
	public static function buildVersion() {
		if (self::$version === false) {
			...
			self::$version = ('1.7.0' == '@' . 'kunenaversion' . '@') ? strtoupper ( $version [1] . '-SVN' ) : strtoupper ( '1.7.0' );
			self::$version_date = ('2011-08-29' == '@' . 'kunenaversiondate' . '@') ? $svn [2] : '2011-08-29';
			self::$version_name = ('Tale' == '@' . 'kunenaversionname' . '@') ? 'SVN Revision' : 'Tale';
			self::$version_build = ('5135' == '@' . 'kunenaversionbuild' . '@') ? $svn [1] : '5135';
		}
		return self::$version;
	}
