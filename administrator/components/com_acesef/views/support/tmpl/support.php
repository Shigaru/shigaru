...
<table align="center" width="600" border="1">
	...
	<tr>
		<td align="center" colspan="3">
			<br />
			<a href="http://www.joomace.net/downloads/acesef/component" target="_blank">
				<img border="0" src="http://www.joomace.net/acesef_basic.png" width="129" height="174">
			</a>
			&nbsp;
			<a href="http://www.joomace.net/downloads/acesef/component/acesef-plus" target="_blank">
				<img border="0" src="http://www.joomace.net/acesef_plus.png" width="129" height="174">
			</a>
			&nbsp;
			<a href="http://www.joomace.net/downloads/acesef/component/acesef-pro" target="_blank">
				<img border="0" src="http://www.joomace.net/acesef_pro.png" width="129" height="174">
			</a>
			&nbsp;
			<a href="http://www.joomace.net/downloads/acesef/component/acesef-vip" target="_blank">
