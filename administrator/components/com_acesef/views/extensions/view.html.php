...
class AcesefViewExtensions extends AcesefView {
	...
	function view($tpl = null) {
		...
		JToolBarHelper::divider();
		$this->toolbar->appendButton('Popup', 'help1', JText::_('ACESEF_COMMON_HELP'), 'http://www.joomace.net/support/docs/acesef/user-manual/extensions?tmpl=component', 650, 500);
