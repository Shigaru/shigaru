			...
			<td width="50%">
				<fieldset class="adminform">
					...
					<?php if ($this->urls['total'] != 0) { ?>
						<input type="submit" class="button" name="deleteurls" onclick="window.top.setTimeout('window.parent.document.getElementById(\'sbox-window\').close();', 1000);" value="<?php echo JText::_('ACESEF_COMMON_DELETE'); ?>" />
			...
			<td width="50%">
				<fieldset class="adminform" height="350">
					...
					<?php if ($this->meta['total'] != 0) { ?>
						<input type="submit" class="button" name="deletemeta" onclick="window.top.setTimeout('window.parent.document.getElementById(\'sbox-window\').close();', 1000);" value="<?php echo JText::_('ACESEF_COMMON_DELETE'); ?>" />
