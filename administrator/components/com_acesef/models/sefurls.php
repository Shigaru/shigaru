...
class AcesefModelSefUrls extends AcesefModel {
	...
	function getLists() {
        ...
        if ($this->AcesefConfig->ui_sef_published == 1) {
			...
			$used_list[] = JHTML::_('select.option', '2', JText::_('ACESEF_COMMON_YES'));
		...
		// Locked Filter
			...
			$locked_list[] = JHTML::_('select.option', '1', JText::_('ACESEF_COMMON_YES'));
		...
		// Blocked Filter
			...
			$blocked_list[] = JHTML::_('select.option', '1', JText::_('ACESEF_COMMON_YES'));
