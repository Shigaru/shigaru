...
class AcesefModelExtensions extends AcesefModel {
	...
	function getToolbarSelections() {
        ...
        // Actions
        $act[] = JHTML::_('select.option', 'savedeleteurls', JText::_('ACESEF_COMMON_SAVE') .' & '. JText::_('ACESEF_TOOLBAR_DELETE_URLS'));
        $act[] = JHTML::_('select.option', 'saveupdateurls', JText::_('ACESEF_COMMON_SAVE') .' & '. JText::_('ACESEF_TOOLBAR_UPDATE_URLS'));
	...
	function getLists() {
		...
		$skip_list[] = JHTML::_('select.option', '1', JText::_('ACESEF_COMMON_YES'));
