  ...
  <div class="sic-right">
    ...
    <div class="standard">
      ...
      <?php if ($this->_tpl_vars['print_videourl']): ?>
          <div class="padding"><form name="vlink" action="#"><div><?php echo @_HWDVIDS_TITLE_PERMALINK; ?>
</div><input type="text" value="<?php echo $this->_tpl_vars['videoplayer']->videourl; ?>
" name="vlink" /></form></div>
      <?php endif; ?>
      <?php if ($this->_tpl_vars['print_embedcode']): ?>
          <div class="padding"><form name="elink" action="#"><div><?php echo @_HWDVIDS_INFO_VIDEMBEDCODE; ?>
