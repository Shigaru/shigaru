...
<div class="standard">
 ...
 <?php echo $this->_tpl_vars['featured_video_details']->editvideo; ?>
 <?php echo $this->_tpl_vars['featured_video_details']->deletevideo; ?>
 <?php echo $this->_tpl_vars['featured_video_details']->publishvideo; ?>
</h2>
	<div class="padding">
		<center>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<div style="text-align:right;padding:5px;">
			<a href="<?php echo $this->_tpl_vars['featured_link']; ?>
