	...
	<?php if ($this->_tpl_vars['print_featured']): ?>
		<div class="hwdmodule-h3">
			<?php if ($this->_tpl_vars['print_featured_player']): ?>
				<?php if ($this->_tpl_vars['showFeaturedDetails']): ?>
					<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "featured_videos_03.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				<?php else: ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => 'navigation_selects.tpl', 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    </div>
...
unset($_smarty_tpl_vars);
 ?>
      ...
      <?php endif; ?>
      <div><center><?php echo $this->_tpl_vars['pageNavigation']; ?>
</center></div>
    </div>
