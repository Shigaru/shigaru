<?php /* Smarty version 2.6.26, created on 2011-12-10 19:45:41
         compiled from upload_thirdparty.tpl */ ?>
<?php echo '
<style>
        span.reference{
            position:fixed;
...
<div id="contentSliderForm" class="clear">
	<div id="wrapperSliderForm">
		<div id="steps">
			<form id="formElem" name="formElem" action="<?php echo $this->_tpl_vars['form_tp']; ?>
" method="post">
...
" class="required" disabled="disabled" class="required" id="shigaruuser" name="shigaruuser" size="40"/>
				...
				<fieldset class="step">
                        ...
                        <input type="hidden" name="videotype" value="<?php echo $this->_tpl_vars['videotype']; ?>
" />
						<input type="hidden" name="video_id" value="<?php echo $this->_tpl_vars['videoInfo']->video_id; ?>
" />
						<input type="hidden" name="video_length" value="<?php echo $this->_tpl_vars['videoInfo']->video_length; ?>
" />
						<input type="hidden" name="infopassed" value="<?php echo $this->_tpl_vars['infoPassed']; ?>
" />
						<input type="hidden" name="ip_added" value="<?php echo $this->_tpl_vars['ipaddress']; ?>
" />
						<input name="embeddump" value="<?php echo $this->_tpl_vars['videourl']; ?>
" class="inputbox" type="hidden" />
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
