...
<div id="totalvideos">
	<span class="fontbold"><?php echo @_HWDVIDS_INFO_TOTVID; ?>
: </span><span class="fontred"><?php echo $this->_tpl_vars['totalvideos']; ?>
</span> <?php echo @_HWDVIDS_SHIGARU_TOTALCATEGORIZED; ?>
...
<div id="tabs">
	<ul>
		...
		<li><a href="#tabs-4"><?php echo $this->_tpl_vars['title_mostfavoured']; ?>
</a></li>
...
?>
			  <div class="videoBox">
			  <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "video_list_full_small_comments.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			  </div>
...
"><?php echo @_HWDVIDS_WATCHMORE; ?>
  ...
  <div id="comments-tabs">
	<ul>
		...
		<li><a href="#comments-tabs-3"><?php echo @_HWDVIDS_RECENTUPDATES; ?>
</a></li>
		<li><a href="#comments-tabs-4"><?php echo @_HWDVIDS_RECENTACTVITY; ?>
</a></li>
		<li><a href="#comments-tabs-5"><?php echo @_HWDVIDS_TOPPOSTERS; ?>
</a></li>
	</ul>
	...
	<div id="comments-tabs-1" class="standard">
      ...
      <div class="introtext">
		<?php echo @_HWDVIDS_LATESTCOMMINTRO; ?>
	...
	<div id="comments-tabs-2" class="standard">
      <div class="scoller h250">
      <div class="introtext">
		<?php echo @_HWDVIDS_POPUCOMMINTRO; ?>
    ...
    <div id="comments-tabs-3" class="standard">
      <div class="scoller h250">
      <div class="introtext">
		<?php echo @_HWDVIDS_RECENTUPDATESINTRO; ?>
    ...
    <div id="comments-tabs-4" class="standard">
      <div class="scoller h250">
      <div class="introtext">
		<?php echo @_HWDVIDS_RECENTACTVITYINTRO; ?>
    ...
    <div id="comments-tabs-5" class="standard">
      <div class="scoller h250">
      <div class="introtext">
		<?php echo @_HWDVIDS_TOPPOSTERSINTRO; ?>
      ...
      <div class="list">
		...
		<div id="whitebox">
				...
				<div class="viewmore">
					<a href="http://twitter.com/shigaru" title="<?php echo @_HWDVIDS_SHIGARU_FOLLOWUSTWEET; ?>
">
						<?php echo @_HWDVIDS_SHIGARU_FOLLOWUSTWEET; ?>
...
"><?php echo @_HWDVIDS_SUBSARCHIVE; ?>
		...
		<div id="withoutMusic">
					<blockquote cite="Brian Littrell">
						<p>
						<?php echo @_HWDVIDS_WITHOUTMUSIC; ?>
...
unset($_smarty_tpl_vars);
 ...
 <div id="tabs-tags">   
    ...
    <div id="tabs-tags-1" class="standard">
      ...
      <div class="introtext">
		<?php echo @_HWDVIDS_SHIGARU_TAGSBANDSINTRO; ?>

      </div>
      <div class="list">
        <div class="box">
          <?php echo $this->_tpl_vars['bandtagsList']; ?>
    ...
    <div id="tabs-tags-2" class="standard">
      <div class="scoller miniscoller">
      <div class="introtext">
		<?php echo @_HWDVIDS_SHIGARU_TAGSINTRO; ?>
    ...
    <div id="tabs-tags-3" class="standard">
      <div class="scoller miniscoller">
      <div class="introtext">
		<?php echo @_HWDVIDS_SHIGARU_TAGSGENREINTRO; ?>
  ...
  <div id="whitebox">
    ...
    <div id="whitebox">
				...
				<div id="whitebox_m">
					<div class="promotext">
						<?php echo @_HWDVIDS_DONATETEXT; ?>

					</div>
					<div id="donatebutton"><?php echo $this->_tpl_vars['donate']; ?>
</div>
					<div class="clr"></div>
    ...
    <div id="whitebox">
				...
				<div id="whitebox_m">
					<div class="promotext">
						<?php echo @_HWDVIDS_FOLLOWOTHERSHITES; ?>
		...
		<div id="addTop">
			...
			<div id="backtotop">
				<a href="#up"><?php echo @_HWDVIDS_TOPPAGE; ?>
</a>
			</div>
			<?php echo $this->_tpl_vars['AddThis']; ?>
