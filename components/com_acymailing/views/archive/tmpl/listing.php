...
<form action="<?php echo acymailing::completeLink('archive&listid='.$this->list->listid); ?>" method="post" name="adminForm">
	...
	?>
		<span class="acynewbutton"><a href="<?php echo acymailing::completeLink('newsletter&task=add&listid='.$this->list->listid); ?>"><img src="<?php echo JURI::base(true); ?>/images/M_images/new.png"/></a></span>
	<?php } ?>
