<?php
/**
* @version $Id: showcat.php 834 2009-06-11 08:36:32Z mahagr $
* Kunena Component
* @package Kunena
*
...
<!-- B: List Actions -->
	...
	<table class="fb_list_actions" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		</td><td class="fb_list_pages_all" width="auto">
		...
		if (count($messages[0]) > 0)
		{
			...
			echo $pagination = KunenaShowcatPagination($catid, $page, $totalpages, $maxpages);
                ...
                ?>
            </td><td class="fb_list_actions_forum" width="auto">
...
<td class="fb_list_actions_forum" width="auto">
<div class="fb_message_buttons_cover" style="text-align: left;">
                <?php
		if (isset($forum_new) || isset($forum_markread))
		{
	       if (isset($forum_new)) echo $forum_new;        if (isset($forum_markread)) 
echo ' '.$forum_markread;
	}
		?></div>
</td>
