<?php
/**
* @version $Id: flat.php 904 2009-07-06 21:58:57Z mahagr $
* Kunena Component
* @package Kunena
*
...
$topic_emoticons = array ();
        ...
        $topic_emoticons[1] = KUNENA_URLEMOTIONSPATH . '01.png';
        $topic_emoticons[2] = KUNENA_URLEMOTIONSPATH . '02.png';
        $topic_emoticons[3] = KUNENA_URLEMOTIONSPATH . '03.png';
        $topic_emoticons[4] = KUNENA_URLEMOTIONSPATH . '04.png';
        $topic_emoticons[5] = KUNENA_URLEMOTIONSPATH . '05.png';
        $topic_emoticons[6] = KUNENA_URLEMOTIONSPATH . '06.png';
        $topic_emoticons[7] = KUNENA_URLEMOTIONSPATH . '07.png';
		$topic_emoticons[8] = KUNENA_URLEMOTIONSPATH . '08.png';
		$topic_emoticons[9] = KUNENA_URLEMOTIONSPATH . '09.png';
		$topic_emoticons[10] = KUNENA_URLEMOTIONSPATH . '10.png';
		$topic_emoticons[11] = KUNENA_URLEMOTIONSPATH . '11.png';
		$topic_emoticons[12] = KUNENA_URLEMOTIONSPATH . '12.png';
		$topic_emoticons[13] = KUNENA_URLEMOTIONSPATH . '13.png';
		$topic_emoticons[14] = KUNENA_URLEMOTIONSPATH . '14.png';
		$topic_emoticons[15] = KUNENA_URLEMOTIONSPATH . '15.png';
		$topic_emoticons[16] = KUNENA_URLEMOTIONSPATH . '16.png';
		$topic_emoticons[17] = KUNENA_URLEMOTIONSPATH . '17.png';
    ...
    <form action = "index.php" method = "post" name = "fbBulkActionForm">
        ...
        <?php  if ($funclatest || $funcmylatest){ } else {  ?>
          ...
          <?php } ?>
            ...
            <tbody>
                <tr  class = "fb_sthtopic fbs ">
                 <th class = "th-0 <?php echo $boardclass ?>sectiontableheader" width="5%"><span class= "sthtopicth"><?php echo _GEN_REPLIES; ?></span></th>
...
<?php echo (int)$thread_counts[$leaf->id]; ?>
                        ...
                        ?>
                                ...
                                <td class = "td-2"  align="center">
                                    <?php echo CKunenaLink::GetSimpleLink($id);
                                    	echo $leaf->topic_emoticon == 0 ? '<img src="' . KUNENA_URLEMOTIONSPATH . 'default.png" border="0"  alt="" />' : "<img src=\"" . $topic_emoticons[$leaf->topic_emoticon] . "\" alt=\"emo\" border=\"0\" />"; ?>
                                </td>
        ...
        <?php } ?>
					...
					} else if (array_key_exists('favoritestar_grey', $fbIcons))
					{
                                    ...
                                    if ($totalMessages > $fbConfig->messages_per_page)
                                    {
                                        ...
                                        echo ' '.CKunenaLink::GetThreadPageLink($fbConfig, 'view', $leaf->catid, $leaf->id, 1, $fbConfig->messages_per_page, 1);
     ...
     <!--   <span class="topic_posted_time"><?php echo _KUNENA_POSTED_AT ?> <?php echo time_since($leaf->time , time() + ($fbConfig->board_ofset * 3600)); ?> <?php echo _KUNENA_AGO ?>
		...
		<span class="topic_posted_time"> <?php echo " " .date(_DATETIME, $leaf->time); ?></span>
<?php
	if ($leaf->name) 
	{
...
<!--        <span class="topic_locked">
		  	...
		  	$javatar =  $last_reply[$leaf->id]->avatar;
		   	if ($javatar!='') {
				echo CKunenaLink::GetProfileLink($fbConfig, $last_reply[$leaf->id]->userid, '<img class="fb_list_avatar" src="'.(!file_exists(KUNENA_PATH_UPLOADED .DS. 'avatars/s_' . $javatar)?KUNENA_LIVEUPLOADEDPATH.'/avatars/'.$javatar:KUNENA_LIVEUPLOADEDPATH.'/avatars/s_'.$javatar) .'" alt="" />');
		   		...
		   		echo CKunenaLink::GetProfileLink($fbConfig, $last_reply[$leaf->id]->userid, '<img class="fb_list_avatar" src="'.KUNENA_LIVEUPLOADEDPATH.'/avatars/s_nophoto.png" alt="" />');
	        }
  ...
  <!-- /Avatar -->
    ...
    <!--    <span class="topic_date">
		...
		<span class="topic_date"><?php echo " " .date(_DATETIME, $last_reply[$leaf->id]->time); ?></span>
        <!-- /Latest Post Date -->
        </div>
