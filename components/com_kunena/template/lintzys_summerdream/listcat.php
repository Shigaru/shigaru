                    ...
                    <tr>
                        <th colspan = "5">
                            <div class = "fb_title_cover fbm" >
                                <?php
                                echo CKunenaLink::GetCategoryLink('listcat', $cat->id, kunena_htmlspecialchars(stripslashes($cat->name)), 'follow', $class='fb_title fbl');;?></div> <span class="knshrinkdescription">
<img id = "BoxSwitch_<?php echo $cat->id ; ?>__catid_<?php echo $cat->id ; ?>" class = "hideshow" src = "<?php echo KUNENA_URLIMAGESPATH . 'shrink.gif' ; ?>" alt = ""/></span></th></tr>
                            <?php    if ($cat->description != "") {
								echo '<tr width="100%"><td colspan=5 width="100%"   class="kncatdescription">';
						echo '' .
                ...
                <tbody id = "catid_<?php echo $cat->id ; ?>">
                    <tr class = "fb_sth fbs ">
                        ...
                        <th class = "th-2 <?php echo $boardclass; ?>sectiontableheader" align="left" width="50%"><?php echo _GEN_FORUM; ?></th>
...
<?php echo _GEN_REPLIES; ?>
                        ...
                        <th class = "th-5 <?php echo $boardclass; ?>sectiontableheader" align="left" width="30%">
<?php echo _GEN_LAST_POST; ?>
                    ...
                    ?>
                                ...
                                <tr class = "<?php echo ''.$boardclass.'' . $tabclass[$k] . ''; ?>" id="fb_cat<?php echo $singlerow->id ?>">
                                    <td class = "td-1" align="center" width="10%">
                                        <?php
                                        $tmpIcon = '';
                                    ...
                                    <td class = "td-2" align="left" width="45%">
                                        ...
                                        ?>
                                            ...
                                            <div class = "<?php echo $boardclass ?>thead-desc fbm"><span class ="forumdescnewrow">
<?php echo $forumDesc ?></span>
                                            </div>
...
echo '</span>';?>:
                                    ...
                                    <td class = "td-3  fbm" align="center" width="5%"><?php echo $numtopics; ?></td>

                                    <td class = "td-4  fbm" align="center" width="5%">
<?php                                   echo $numreplies; ?>
                                    </td>
                                    ...
                                    ?>
                                        ...
                                        <td class = "td-5" align="left" width="35%">
...
?>
                                            ...
                                            <div class = "<?php echo $boardclass ?>latest-subject-by fbs"><span class="fromuserleft">
<?php
echo '<span class="td5von">';                                          
echo _GEN_BY.' ';
echo '</span>';
                                                echo CKunenaLink::GetProfileLink($fbConfig, $latestuserid, $latestname);echo '</span>';
												echo '<span class="td5lastptime">';
                                                echo ' '.$lastptime.' ';
