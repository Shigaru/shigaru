<?php
/**
* @version $Id: message.php 827 2009-06-09 19:53:37Z mahagr $
* Kunena Component
* @package Kunena
*
...
?>
        ...
        <tr> <!-- -->
              <td colspan="0" class = "fb-msgview-left">
...
<div class= "viewcovercontainer">
                ...
                <div class = "viewcover">
                   ...
                   <div class = "viewcover_online"> <?php
                    if (isset($msg_online)) {
                        echo $msg_online;
                    }
                    ?>
        ...
        <td class = "fb-msgview-right">
                <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                    <tr class="yellowbg">
						...
						<span class = "<?php echo $msgtitle; ?>"><?php echo $msg_subject; ?> </span> <span class = "msgdate" title="<?php echo $msg_date; ?>"><?php echo $msg_date; ?></span>
	...
	<tr>
	<td colspan="0" class = "fb-msgview-left-b">&nbsp;
...
<?php
if ($msg_signature) {
	echo '<td><div class="msgsignature">';
...
<!--	<div class="kunena_message_button">
	<div class="fb_message_buttons_cover">
		...
		<tr><td colspan="4"><table width="100%" cellpadding="0" cellspacing="0"><tr class = "fb-modbottom">
		<td class="fb_list_actions_go_only">
                        <?php
                        //go to bottom
	...
	echo '</td>';?> <td class="fb_list_actions_go_next">
<!-- if ($msg_signature) {
	echo '<td><div class="msgsignature">';
	echo '<div class="kunena_signature">';
	echo $msg_signature;
