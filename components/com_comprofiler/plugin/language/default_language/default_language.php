...
DEFINE('_UE_ONYOURMIND','What\'s on your mind?');
DEFINE('_UE_LASTSTATUSUPDATE','Last status update');
...
DEFINE("_UE_CONGOTHEDEMOCRATICREPUBLICOFTHE", "Congo, The Democratic Republic Of The");
...
DEFINE("_UE_HEARDISLANDANDMCDONALDISLANDS", "Heard Island And Mcdonald Islands");
...
DEFINE("_UE_KOREADEMOCRATICPEOPLESREPUBLICOF", "Korea, Democratic People's Republic Of");
...
DEFINE("_UE_MACEDONIATHEFORMERYUGOSLAVREPUBLICOF", "Macedonia, The Former Yugoslav Republic Of");
...
DEFINE("_UE_SOUTHGEORGIAANDTHESOUTHSANDWICHISLANDS", "South Georgia And The South Sandwich Islands");
...
DEFINE("_UE_UNITEDSTATESMINOROUTLYINGISLANDS", "United States Minor Outlying Islands");
...
define('_UE_USERNAME_DOESNT_EXISTS',"'%s' is available for you to use!");
...
define('_UE_USERNAME_FREE_OK_TO_PROCEED',"'%s' is available for you to use!");
...
DEFINE('_UE_VALID_UNAME','Please enter a valid username with at least 3 characters in length and containing some of the allowed chars:0-9,a-z,A-Z');
DEFINE('_UE_VALID_UNAME_CHARS','Please enter a valid username with at least 3 characters in length and containing some of the allowed chars: 0-9,a-z,A-Z');
