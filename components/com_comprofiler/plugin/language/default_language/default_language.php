...
.'<div class="componentheading mbot20"><p>An email has just been sent to you reminding you of your account and password details. So, what would you like to do now?</p>'
.'<p>We recommend you to log in and start rating, commenting and uploading! Or maybe you want to visit the Home page or start browsing the Video Library?</p>');
...
DEFINE("UE_AFGHANISTAN", "Afghanistan");
DEFINE("UE_ALAND ISLANDS", "Aland Islands");
DEFINE("UE_ALBANIA", "Albania");
DEFINE("UE_ALGERIA", "Algeria");
DEFINE("UE_AMERICAN SAMOA", "American Samoa");
DEFINE("UE_ANDORRA", "Andorra");
DEFINE("UE_ANGOLA", "Angola");
DEFINE("UE_ANGUILLA", "Anguilla");
DEFINE("UE_ANTARCTICA", "Antarctica");
DEFINE("UE_ANTIGUA AND BARBUDA", "Antigua And Barbuda");
DEFINE("UE_ARGENTINA", "Argentina");
DEFINE("UE_ARMENIA", "Armenia");
DEFINE("UE_ARUBA", "Aruba");
DEFINE("UE_AUSTRALIA", "Australia");
DEFINE("UE_AUSTRIA", "Austria");
DEFINE("UE_AZERBAIJAN", "Azerbaijan");
DEFINE("UE_BAHAMAS", "Bahamas");
DEFINE("UE_BAHRAIN", "Bahrain");
DEFINE("UE_BANGLADESH", "Bangladesh");
DEFINE("UE_BARBADOS", "Barbados");
DEFINE("UE_BELARUS", "Belarus");
DEFINE("UE_BELGIUM", "Belgium");
DEFINE("UE_BELIZE", "Belize");
DEFINE("UE_BENIN", "Benin");
DEFINE("UE_BERMUDA", "Bermuda");
DEFINE("UE_BHUTAN", "Bhutan");
DEFINE("UE_BOLIVIA", "Bolivia");
DEFINE("UE_BOSNIA AND HERZEGOVINA", "Bosnia And Herzegovina");
DEFINE("UE_BOTSWANA", "Botswana");
DEFINE("UE_BOUVET ISLAND", "Bouvet Island");
DEFINE("UE_BRAZIL", "Brazil");
DEFINE("UE_BRITISH INDIAN OCEAN TERRITORY", "British Indian Ocean Territory");
DEFINE("UE_BRUNEI DARUSSALAM", "Brunei Darussalam");
DEFINE("UE_BULGARIA", "Bulgaria");
DEFINE("UE_BURKINA FASO", "Burkina Faso");
DEFINE("UE_BURUNDI", "Burundi");
DEFINE("UE_CAMBODIA", "Cambodia");
DEFINE("UE_CAMEROON", "Cameroon");
DEFINE("UE_CANADA", "Canada");
DEFINE("UE_CAPE VERDE", "Cape Verde");
DEFINE("UE_CAYMAN ISLANDS", "Cayman Islands");
DEFINE("UE_CENTRAL AFRICAN REPUBLIC", "Central African Republic");
DEFINE("UE_CHAD", "Chad");
DEFINE("UE_CHILE", "Chile");
DEFINE("UE_CHINA", "China");
DEFINE("UE_CHRISTMAS ISLAND", "Christmas Island");
DEFINE("UE_COCOS (KEELING) ISLANDS", "Cocos (Keeling) Islands");
DEFINE("UE_COLOMBIA", "Colombia");
DEFINE("UE_COMOROS", "Comoros");
DEFINE("UE_CONGO", "Congo");
DEFINE("UE_CONGO, THE DEMOCRATIC REPUBLIC OF THE", "Congo, The Democratic Republic Of The");
DEFINE("UE_COOK ISLANDS", "Cook Islands");
DEFINE("UE_COSTA RICA", "Costa Rica");
DEFINE("UE_COTE D'IVOIRE", "Cote D'Ivoire");
DEFINE("UE_CROATIA", "Croatia");
DEFINE("UE_CUBA", "Cuba");
DEFINE("UE_CYPRUS", "Cyprus");
DEFINE("UE_CZECH REPUBLIC", "Czech Republic");
DEFINE("UE_DENMARK", "Denmark");
DEFINE("UE_DJIBOUTI", "Djibouti");
DEFINE("UE_DOMINICA", "Dominica");
DEFINE("UE_DOMINICAN REPUBLIC", "Dominican Republic");
DEFINE("UE_ECUADOR", "Ecuador");
DEFINE("UE_EGYPT", "Egypt");
DEFINE("UE_EL SALVADOR", "El Salvador");
DEFINE("UE_EQUATORIAL GUINEA", "Equatorial Guinea");
DEFINE("UE_ERITREA", "Eritrea");
DEFINE("UE_ESTONIA", "Estonia");
DEFINE("UE_ETHIOPIA", "Ethiopia");
DEFINE("UE_FALKLAND ISLANDS (MALVINAS)", "Falkland Islands (Malvinas)");
DEFINE("UE_FAROE ISLANDS", "Faroe Islands");
DEFINE("UE_FIJI", "Fiji");
DEFINE("UE_FINLAND", "Finland");
DEFINE("UE_FRANCE", "France");
DEFINE("UE_FRENCH GUIANA", "French Guiana");
DEFINE("UE_FRENCH POLYNESIA", "French Polynesia");
DEFINE("UE_FRENCH SOUTHERN TERRITORIES", "French Southern Territories");
DEFINE("UE_GABON", "Gabon");
DEFINE("UE_GAMBIA", "Gambia");
DEFINE("UE_GEORGIA", "Georgia");
DEFINE("UE_GERMANY", "Germany");
DEFINE("UE_GHANA", "Ghana");
DEFINE("UE_GIBRALTAR", "Gibraltar");
DEFINE("UE_GREECE", "Greece");
DEFINE("UE_GREENLAND", "Greenland");
DEFINE("UE_GRENADA", "Grenada");
DEFINE("UE_GUADELOUPE", "Guadeloupe");
DEFINE("UE_GUAM", "Guam");
DEFINE("UE_GUATEMALA", "Guatemala");
DEFINE("UE_GUERNSEY", "Guernsey");
DEFINE("UE_GUINEA", "Guinea");
DEFINE("UE_GUINEA-BISSAU", "Guinea-Bissau");
DEFINE("UE_GUYANA", "Guyana");
DEFINE("UE_HAITI", "Haiti");
DEFINE("UE_HEARD ISLAND AND MCDONALD ISLANDS", "Heard Island And Mcdonald Islands");
DEFINE("UE_HOLY SEE (VATICAN CITY STATE)", "Holy See (Vatican City State)");
DEFINE("UE_HONDURAS", "Honduras");
DEFINE("UE_HONG KONG", "Hong Kong");
DEFINE("UE_HUNGARY", "Hungary");
DEFINE("UE_ICELAND", "Iceland");
DEFINE("UE_INDIA", "India");
DEFINE("UE_INDONESIA", "Indonesia");
DEFINE("UE_IRAN, ISLAMIC REPUBLIC OF", "Iran, Islamic Republic Of");
DEFINE("UE_IRAQ", "Iraq");
DEFINE("UE_IRELAND", "Ireland");
DEFINE("UE_ISLE OF MAN", "Isle Of Man");
DEFINE("UE_ISRAEL", "Israel");
DEFINE("UE_ITALY", "Italy");
DEFINE("UE_JAMAICA", "Jamaica");
DEFINE("UE_JAPAN", "Japan");
DEFINE("UE_JERSEY", "Jersey");
DEFINE("UE_JORDAN", "Jordan");
DEFINE("UE_KAZAKHSTAN", "Kazakhstan");
DEFINE("UE_KENYA", "Kenya");
DEFINE("UE_KIRIBATI", "Kiribati");
DEFINE("UE_KOREA, DEMOCRATIC PEOPLE'S REPUBLIC OF", "Korea, Democratic People'S Republic Of");
DEFINE("UE_KOREA, REPUBLIC OF", "Korea, Republic Of");
DEFINE("UE_KUWAIT", "Kuwait");
DEFINE("UE_KYRGYZSTAN", "Kyrgyzstan");
DEFINE("UE_LAO PEOPLE'S DEMOCRATIC REPUBLIC", "Lao People'S Democratic Republic");
DEFINE("UE_LATVIA", "Latvia");
DEFINE("UE_LEBANON", "Lebanon");
DEFINE("UE_LESOTHO", "Lesotho");
DEFINE("UE_LIBERIA", "Liberia");
DEFINE("UE_LIBYAN ARAB JAMAHIRIYA", "Libyan Arab Jamahiriya");
DEFINE("UE_LIECHTENSTEIN", "Liechtenstein");
DEFINE("UE_LITHUANIA", "Lithuania");
DEFINE("UE_LUXEMBOURG", "Luxembourg");
DEFINE("UE_MACAO", "Macao");
DEFINE("UE_MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF", "Macedonia, The Former Yugoslav Republic Of");
DEFINE("UE_MADAGASCAR", "Madagascar");
DEFINE("UE_MALAWI", "Malawi");
DEFINE("UE_MALAYSIA", "Malaysia");
DEFINE("UE_MALDIVES", "Maldives");
DEFINE("UE_MALI", "Mali");
DEFINE("UE_MALTA", "Malta");
DEFINE("UE_MARSHALL ISLANDS", "Marshall Islands");
DEFINE("UE_MARTINIQUE", "Martinique");
DEFINE("UE_MAURITANIA", "Mauritania");
DEFINE("UE_MAURITIUS", "Mauritius");
DEFINE("UE_MAYOTTE", "Mayotte");
DEFINE("UE_MEXICO", "Mexico");
DEFINE("UE_MICRONESIA, FEDERATED STATES OF", "Micronesia, Federated States Of");
DEFINE("UE_MOLDOVA, REPUBLIC OF", "Moldova, Republic Of");
DEFINE("UE_MONACO", "Monaco");
DEFINE("UE_MONGOLIA", "Mongolia");
DEFINE("UE_MONTSERRAT", "Montserrat");
DEFINE("UE_MOROCCO", "Morocco");
DEFINE("UE_MOZAMBIQUE", "Mozambique");
DEFINE("UE_MYANMAR", "Myanmar");
DEFINE("UE_NAMIBIA", "Namibia");
DEFINE("UE_NAURU", "Nauru");
DEFINE("UE_NEPAL", "Nepal");
DEFINE("UE_NETHERLANDS", "Netherlands");
DEFINE("UE_NETHERLANDS ANTILLES", "Netherlands Antilles");
DEFINE("UE_NEW CALEDONIA", "New Caledonia");
DEFINE("UE_NEW ZEALAND", "New Zealand");
DEFINE("UE_NICARAGUA", "Nicaragua");
DEFINE("UE_NIGER", "Niger");
DEFINE("UE_NIGERIA", "Nigeria");
DEFINE("UE_NIUE", "Niue");
DEFINE("UE_NORFOLK ISLAND", "Norfolk Island");
DEFINE("UE_NORTHERN MARIANA ISLANDS", "Northern Mariana Islands");
DEFINE("UE_NORWAY", "Norway");
DEFINE("UE_OMAN", "Oman");
DEFINE("UE_PAKISTAN", "Pakistan");
DEFINE("UE_PALAU", "Palau");
DEFINE("UE_PALESTINIAN TERRITORY, OCCUPIED", "Palestinian Territory, Occupied");
DEFINE("UE_PANAMA", "Panama");
DEFINE("UE_PAPUA NEW GUINEA", "Papua New Guinea");
DEFINE("UE_PARAGUAY", "Paraguay");
DEFINE("UE_PERU", "Peru");
DEFINE("UE_PHILIPPINES", "Philippines");
DEFINE("UE_PITCAIRN", "Pitcairn");
DEFINE("UE_POLAND", "Poland");
DEFINE("UE_PORTUGAL", "Portugal");
DEFINE("UE_PUERTO RICO", "Puerto Rico");
DEFINE("UE_QATAR", "Qatar");
DEFINE("UE_REUNION", "Reunion");
DEFINE("UE_ROMANIA", "Romania");
DEFINE("UE_RUSSIAN FEDERATION", "Russian Federation");
DEFINE("UE_RWANDA", "Rwanda");
DEFINE("UE_SAINT HELENA", "Saint Helena");
DEFINE("UE_SAINT KITTS AND NEVIS", "Saint Kitts And Nevis");
DEFINE("UE_SAINT LUCIA", "Saint Lucia");
DEFINE("UE_SAINT PIERRE AND MIQUELON", "Saint Pierre And Miquelon");
DEFINE("UE_SAINT VINCENT AND THE GRENADINES", "Saint Vincent And The Grenadines");
DEFINE("UE_SAMOA", "Samoa");
DEFINE("UE_SAN MARINO", "San Marino");
DEFINE("UE_SAO TOME AND PRINCIPE", "Sao Tome And Principe");
DEFINE("UE_SAUDI ARABIA", "Saudi Arabia");
DEFINE("UE_SENEGAL", "Senegal");
DEFINE("UE_SERBIA AND MONTENEGRO", "Serbia And Montenegro");
DEFINE("UE_SEYCHELLES", "Seychelles");
DEFINE("UE_SIERRA LEONE", "Sierra Leone");
DEFINE("UE_SINGAPORE", "Singapore");
DEFINE("UE_SLOVAKIA", "Slovakia");
DEFINE("UE_SLOVENIA", "Slovenia");
DEFINE("UE_SOLOMON ISLANDS", "Solomon Islands");
DEFINE("UE_SOMALIA", "Somalia");
DEFINE("UE_SOUTH AFRICA", "South Africa");
DEFINE("UE_SOUTH GEORGIA AND THE SOUTH SANDWICH ISLANDS", "South Georgia And The South Sandwich Islands");
DEFINE("UE_SPAIN", "Spain");
DEFINE("UE_SRI LANKA", "Sri Lanka");
DEFINE("UE_SUDAN", "Sudan");
DEFINE("UE_SURINAME", "Suriname");
DEFINE("UE_SVALBARD AND JAN MAYEN", "Svalbard And Jan Mayen");
DEFINE("UE_SWAZILAND", "Swaziland");
DEFINE("UE_SWEDEN", "Sweden");
DEFINE("UE_SWITZERLAND", "Switzerland");
DEFINE("UE_SYRIAN ARAB REPUBLIC", "Syrian Arab Republic");
DEFINE("UE_TAIWAN, PROVINCE OF CHINA", "Taiwan, Province Of China");
DEFINE("UE_TAJIKISTAN", "Tajikistan");
DEFINE("UE_TANZANIA, UNITED REPUBLIC OF", "Tanzania, United Republic Of");
DEFINE("UE_THAILAND", "Thailand");
DEFINE("UE_TIMOR-LESTE", "Timor-Leste");
DEFINE("UE_TOGO", "Togo");
DEFINE("UE_TOKELAU", "Tokelau");
DEFINE("UE_TONGA", "Tonga");
DEFINE("UE_TRINIDAD AND TOBAGO", "Trinidad And Tobago");
DEFINE("UE_TUNISIA", "Tunisia");
DEFINE("UE_TURKEY", "Turkey");
DEFINE("UE_TURKMENISTAN", "Turkmenistan");
DEFINE("UE_TURKS AND CAICOS ISLANDS", "Turks And Caicos Islands");
DEFINE("UE_TUVALU", "Tuvalu");
DEFINE("UE_UGANDA", "Uganda");
DEFINE("UE_UKRAINE", "Ukraine");
DEFINE("UE_UNITED ARAB EMIRATES", "United Arab Emirates");
DEFINE("UE_UNITED KINGDOM", "United Kingdom");
DEFINE("UE_UNITED STATES", "United States");
DEFINE("UE_UNITED STATES MINOR OUTLYING ISLANDS", "United States Minor Outlying Islands");
DEFINE("UE_URUGUAY", "Uruguay");
DEFINE("UE_UZBEKISTAN", "Uzbekistan");
DEFINE("UE_VANUATU", "Vanuatu");
DEFINE("UE_VENEZUELA", "Venezuela");
DEFINE("UE_VIET NAM", "Viet Nam");
DEFINE("UE_VIRGIN ISLANDS, BRITISH", "Virgin Islands, British");
DEFINE("UE_VIRGIN ISLANDS, U.S.", "Virgin Islands, U.S.");
DEFINE("UE_WALLIS AND FUTUNA", "Wallis And Futuna");
DEFINE("UE_WESTERN SAHARA", "Western Sahara");
DEFINE("UE_YEMEN", "Yemen");
DEFINE("UE_ZAMBIA", "Zambia");
DEFINE("UE_ZIMBABWE", "Zimbabwe");
DEFINE("UE_(NOT SPECIFIED)", "(Not Specified)");
